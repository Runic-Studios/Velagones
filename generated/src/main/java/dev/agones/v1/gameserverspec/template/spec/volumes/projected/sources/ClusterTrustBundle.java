...
public class ClusterTrustBundle implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.volumes.projected.sources.clustertrustbundle.LabelSelector labelSelector;

    public dev.agones.v1.gameserverspec.template.spec.volumes.projected.sources.clustertrustbundle.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(dev.agones.v1.gameserverspec.template.spec.volumes.projected.sources.clustertrustbundle.LabelSelector labelSelector) {
