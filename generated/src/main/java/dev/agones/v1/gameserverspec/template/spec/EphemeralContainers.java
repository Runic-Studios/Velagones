...
public class EphemeralContainers implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Env> env;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.EnvFrom> envFrom;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.EnvFrom> getEnvFrom() {
        return envFrom;
    }

    public void setEnvFrom(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.EnvFrom> envFrom) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Lifecycle lifecycle;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Lifecycle getLifecycle() {
        return lifecycle;
    }

    public void setLifecycle(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Lifecycle lifecycle) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.LivenessProbe livenessProbe;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Ports> ports;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Ports> getPorts() {
        return ports;
    }

    public void setPorts(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Probes are not allowed for ephemeral containers.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ReadinessProbe readinessProbe;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ResizePolicy> resizePolicy;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ResizePolicy> getResizePolicy() {
        return resizePolicy;
    }

    public void setResizePolicy(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.ResizePolicy> resizePolicy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Resources resources;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Resources getResources() {
        return resources;
    }

    public void setResources(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.SecurityContext securityContext;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Probes are not allowed for ephemeral containers.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.StartupProbe startupProbe;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.StartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.StartupProbe startupProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeDevices> volumeDevices;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeDevices> getVolumeDevices() {
        return volumeDevices;
    }

    public void setVolumeDevices(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeDevices> volumeDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeMounts> volumeMounts;

    public java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeMounts> getVolumeMounts() {
        return volumeMounts;
    }

    public void setVolumeMounts(java.util.List<dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.VolumeMounts> volumeMounts) {
