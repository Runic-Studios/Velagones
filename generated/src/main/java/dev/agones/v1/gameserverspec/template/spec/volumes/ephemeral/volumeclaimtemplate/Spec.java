package dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource;

    public dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef;

    public dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources;

    public dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources getResources() {
        return resources;
    }

    public void setResources(dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector;

    public dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector getSelector() {
        return selector;
    }

    public void setSelector(dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector) {
