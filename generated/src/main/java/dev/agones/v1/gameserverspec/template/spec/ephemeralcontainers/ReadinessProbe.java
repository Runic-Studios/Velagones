...
public class ReadinessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Exec exec;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Grpc grpc;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet httpGet;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket tcpSocket;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket tcpSocket) {
