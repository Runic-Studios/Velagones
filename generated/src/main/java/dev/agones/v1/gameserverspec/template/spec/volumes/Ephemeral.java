...
public class Ephemeral implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.VolumeClaimTemplate volumeClaimTemplate;

    public dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.VolumeClaimTemplate getVolumeClaimTemplate() {
        return volumeClaimTemplate;
    }

    public void setVolumeClaimTemplate(dev.agones.v1.gameserverspec.template.spec.volumes.ephemeral.VolumeClaimTemplate volumeClaimTemplate) {
