...
public class Affinity implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.affinity.NodeAffinity nodeAffinity;

    public dev.agones.v1.gameserverspec.template.spec.affinity.NodeAffinity getNodeAffinity() {
        return nodeAffinity;
    }

    public void setNodeAffinity(dev.agones.v1.gameserverspec.template.spec.affinity.NodeAffinity nodeAffinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.affinity.PodAffinity podAffinity;

    public dev.agones.v1.gameserverspec.template.spec.affinity.PodAffinity getPodAffinity() {
        return podAffinity;
    }

    public void setPodAffinity(dev.agones.v1.gameserverspec.template.spec.affinity.PodAffinity podAffinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.affinity.PodAntiAffinity podAntiAffinity;

    public dev.agones.v1.gameserverspec.template.spec.affinity.PodAntiAffinity getPodAntiAffinity() {
        return podAntiAffinity;
    }

    public void setPodAntiAffinity(dev.agones.v1.gameserverspec.template.spec.affinity.PodAntiAffinity podAntiAffinity) {
