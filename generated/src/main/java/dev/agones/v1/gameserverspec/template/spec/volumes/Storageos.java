...
public class Storageos implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.volumes.storageos.SecretRef secretRef;

    public dev.agones.v1.gameserverspec.template.spec.volumes.storageos.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(dev.agones.v1.gameserverspec.template.spec.volumes.storageos.SecretRef secretRef) {
