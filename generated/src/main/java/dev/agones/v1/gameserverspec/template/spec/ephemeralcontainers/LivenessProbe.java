...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Exec exec;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Grpc grpc;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.HttpGet httpGet;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.TcpSocket tcpSocket;

    public dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(dev.agones.v1.gameserverspec.template.spec.ephemeralcontainers.livenessprobe.TcpSocket tcpSocket) {
