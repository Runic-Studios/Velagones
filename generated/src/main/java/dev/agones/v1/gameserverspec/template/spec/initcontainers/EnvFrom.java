...
public class EnvFrom implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.ConfigMapRef configMapRef;

    public dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.ConfigMapRef getConfigMapRef() {
        return configMapRef;
    }

    public void setConfigMapRef(dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.ConfigMapRef configMapRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.SecretRef secretRef;

    public dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(dev.agones.v1.gameserverspec.template.spec.initcontainers.envfrom.SecretRef secretRef) {
