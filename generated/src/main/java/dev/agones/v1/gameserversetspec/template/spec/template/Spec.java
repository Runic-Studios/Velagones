package dev.agones.v1.gameserversetspec.template.spec.template;
...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.Affinity affinity;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(dev.agones.v1.gameserversetspec.template.spec.template.spec.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Containers> containers;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Containers> getContainers() {
        return containers;
    }

    public void setContainers(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Containers> containers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.DnsConfig dnsConfig;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.DnsConfig getDnsConfig() {
        return dnsConfig;
    }

    public void setDnsConfig(dev.agones.v1.gameserversetspec.template.spec.template.spec.DnsConfig dnsConfig) {
        this.dnsConfig = dnsConfig;
    }

    public enum DnsPolicy {

        @com.fasterxml.jackson.annotation.JsonProperty("ClusterFirst")
        CLUSTERFIRST("ClusterFirst"), @com.fasterxml.jackson.annotation.JsonProperty("ClusterFirstWithHostNet")
        CLUSTERFIRSTWITHHOSTNET("ClusterFirstWithHostNet"), @com.fasterxml.jackson.annotation.JsonProperty("Default")
        DEFAULT("Default"), @com.fasterxml.jackson.annotation.JsonProperty("None")
        NONE("None");

        java.lang.String value;

        DnsPolicy(java.lang.String value) {
            this.value = value;
        }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.EphemeralContainers> ephemeralContainers;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.EphemeralContainers> getEphemeralContainers() {
        return ephemeralContainers;
    }

    public void setEphemeralContainers(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.EphemeralContainers> ephemeralContainers) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.HostAliases> hostAliases;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.HostAliases> getHostAliases() {
        return hostAliases;
    }

    public void setHostAliases(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.HostAliases> hostAliases) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ImagePullSecrets> imagePullSecrets;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ImagePullSecrets> getImagePullSecrets() {
        return imagePullSecrets;
    }

    public void setImagePullSecrets(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ImagePullSecrets> imagePullSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.InitContainers> initContainers;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.InitContainers> getInitContainers() {
        return initContainers;
    }

    public void setInitContainers(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.InitContainers> initContainers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.Os os;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.Os getOs() {
        return os;
    }

    public void setOs(dev.agones.v1.gameserversetspec.template.spec.template.spec.Os os) {
        this.os = os;
    }
    ...
    public enum PreemptionPolicy {
        ...
        NEVER("Never"), @com.fasterxml.jackson.annotation.JsonProperty("PreemptLowerPriority")
        PREEMPTLOWERPRIORITY("PreemptLowerPriority");

        java.lang.String value;

        PreemptionPolicy(java.lang.String value) {
            this.value = value;
        }
    ...
    public void setPreemptionPolicy(PreemptionPolicy preemptionPolicy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ReadinessGates> readinessGates;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ReadinessGates> getReadinessGates() {
        return readinessGates;
    }

    public void setReadinessGates(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ReadinessGates> readinessGates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ResourceClaims> resourceClaims;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ResourceClaims> getResourceClaims() {
        return resourceClaims;
    }

    public void setResourceClaims(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ResourceClaims> resourceClaims) {
    ...
    public enum RestartPolicy {
        ...
        NEVER("Never"), @com.fasterxml.jackson.annotation.JsonProperty("OnFailure")
        ONFAILURE("OnFailure");

        java.lang.String value;

        RestartPolicy(java.lang.String value) {
            this.value = value;
        }
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Restart policy for all containers within the pod. One of Always, OnFailure, Never. In some contexts, only a subset of those values may be permitted. Default to Always. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#restart-policy\n\nPossible enum values:\n - `\"Always\"`\n - `\"Never\"`\n - `\"OnFailure\"`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.SchedulingGates> schedulingGates;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.SchedulingGates> getSchedulingGates() {
        return schedulingGates;
    }

    public void setSchedulingGates(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.SchedulingGates> schedulingGates) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.SecurityContext securityContext;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(dev.agones.v1.gameserversetspec.template.spec.template.spec.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("DeprecatedServiceAccount is a deprecated alias for ServiceAccountName. Deprecated: Use serviceAccountName instead.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Tolerations> tolerations;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Tolerations> tolerations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.TopologySpreadConstraints> topologySpreadConstraints;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.TopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.TopologySpreadConstraints> topologySpreadConstraints) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Volumes> volumes;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.Volumes> volumes) {
