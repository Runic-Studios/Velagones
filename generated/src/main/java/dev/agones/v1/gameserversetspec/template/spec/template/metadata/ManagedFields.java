package dev.agones.v1.gameserversetspec.template.spec.template.metadata;
...
public class ManagedFields implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.metadata.managedfields.FieldsV1 fieldsV1;

    public dev.agones.v1.gameserversetspec.template.spec.template.metadata.managedfields.FieldsV1 getFieldsV1() {
        return fieldsV1;
    }

    public void setFieldsV1(dev.agones.v1.gameserversetspec.template.spec.template.metadata.managedfields.FieldsV1 fieldsV1) {
