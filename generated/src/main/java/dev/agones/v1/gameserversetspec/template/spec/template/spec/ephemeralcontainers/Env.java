...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.env.ValueFrom valueFrom;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.env.ValueFrom valueFrom) {
