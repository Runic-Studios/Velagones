...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.secret.Items> items;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.secret.Items> items) {
        this.items = items;
    }
