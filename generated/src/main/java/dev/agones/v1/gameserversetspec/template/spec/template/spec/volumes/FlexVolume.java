...
public class FlexVolume implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.flexvolume.SecretRef secretRef;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.flexvolume.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.flexvolume.SecretRef secretRef) {
