package dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.lifecycle.prestop;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders) {
