package dev.agones.v1.gameserversetspec.template.spec.template.spec.containers;
...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.AppArmorProfile appArmorProfile;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.AppArmorProfile getAppArmorProfile() {
        return appArmorProfile;
    }

    public void setAppArmorProfile(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.AppArmorProfile appArmorProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.Capabilities capabilities;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeLinuxOptions seLinuxOptions;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeccompProfile seccompProfile;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.WindowsOptions windowsOptions;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.securitycontext.WindowsOptions windowsOptions) {
