...
public class Projected implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.Sources> sources;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.Sources> sources) {
