...
public class Metadata implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.ManagedFields> managedFields;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.ManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.ManagedFields> managedFields) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.OwnerReferences> ownerReferences;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.OwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.metadata.OwnerReferences> ownerReferences) {
