...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.sources.secret.Items> items;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.sources.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.projected.sources.secret.Items> items) {
        this.items = items;
    }
