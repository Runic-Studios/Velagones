...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.AppArmorProfile appArmorProfile;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.AppArmorProfile getAppArmorProfile() {
        return appArmorProfile;
    }

    public void setAppArmorProfile(dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.AppArmorProfile appArmorProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeLinuxOptions seLinuxOptions;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeccompProfile seccompProfile;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.Sysctls> sysctls;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.Sysctls> getSysctls() {
        return sysctls;
    }

    public void setSysctls(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.Sysctls> sysctls) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.WindowsOptions windowsOptions;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(dev.agones.v1.gameserversetspec.template.spec.template.spec.securitycontext.WindowsOptions windowsOptions) {
