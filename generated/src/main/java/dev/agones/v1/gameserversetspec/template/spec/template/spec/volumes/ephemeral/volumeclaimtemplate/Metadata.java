...
public class Metadata implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.time.ZonedDateTime creationTimestamp;
    ...
    public java.time.ZonedDateTime getCreationTimestamp() {
    ...
    public void setCreationTimestamp(java.time.ZonedDateTime creationTimestamp) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.time.ZonedDateTime deletionTimestamp;

    @com.fasterxml.jackson.annotation.JsonFormat(shape = com.fasterxml.jackson.annotation.JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ssVV")
    public java.time.ZonedDateTime getDeletionTimestamp() {
        return deletionTimestamp;
    }

    @com.fasterxml.jackson.annotation.JsonFormat(shape = com.fasterxml.jackson.annotation.JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss[XXX][VV]")
    public void setDeletionTimestamp(java.time.ZonedDateTime deletionTimestamp) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> managedFields;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.ManagedFields> managedFields) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> ownerReferences;

    public java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(java.util.List<dev.agones.v1.gameserversetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.metadata.OwnerReferences> ownerReferences) {
