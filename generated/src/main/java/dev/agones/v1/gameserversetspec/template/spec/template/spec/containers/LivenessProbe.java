...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Exec exec;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Grpc grpc;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.HttpGet httpGet;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.TcpSocket tcpSocket;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(dev.agones.v1.gameserversetspec.template.spec.template.spec.containers.livenessprobe.TcpSocket tcpSocket) {
