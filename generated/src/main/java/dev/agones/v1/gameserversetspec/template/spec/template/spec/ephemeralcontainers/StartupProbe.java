...
public class StartupProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec exec;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc grpc;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet httpGet;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket tcpSocket;

    public dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(dev.agones.v1.gameserversetspec.template.spec.template.spec.ephemeralcontainers.startupprobe.TcpSocket tcpSocket) {
