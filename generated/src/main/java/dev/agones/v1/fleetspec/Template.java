...
public class Template implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private dev.agones.v1.fleetspec.template.Metadata metadata;

    public dev.agones.v1.fleetspec.template.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(dev.agones.v1.fleetspec.template.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.Spec spec;

    public dev.agones.v1.fleetspec.template.Spec getSpec() {
        return spec;
    }

    public void setSpec(dev.agones.v1.fleetspec.template.Spec spec) {
        this.spec = spec;
    }
}
