...
public class InitContainers implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Env> env;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.EnvFrom> envFrom;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.EnvFrom> getEnvFrom() {
        return envFrom;
    }

    public void setEnvFrom(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.EnvFrom> envFrom) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Lifecycle lifecycle;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Lifecycle getLifecycle() {
        return lifecycle;
    }

    public void setLifecycle(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Lifecycle lifecycle) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.LivenessProbe livenessProbe;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Ports> ports;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Ports> getPorts() {
        return ports;
    }

    public void setPorts(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ReadinessProbe readinessProbe;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ResizePolicy> resizePolicy;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ResizePolicy> getResizePolicy() {
        return resizePolicy;
    }

    public void setResizePolicy(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.ResizePolicy> resizePolicy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Resources resources;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Resources getResources() {
        return resources;
    }

    public void setResources(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.SecurityContext securityContext;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.StartupProbe startupProbe;

    public dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.StartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.StartupProbe startupProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeDevices> volumeDevices;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeDevices> getVolumeDevices() {
        return volumeDevices;
    }

    public void setVolumeDevices(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeDevices> volumeDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeMounts> volumeMounts;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeMounts> getVolumeMounts() {
        return volumeMounts;
    }

    public void setVolumeMounts(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.VolumeMounts> volumeMounts) {
