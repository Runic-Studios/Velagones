...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.projected.sources.configmap.Items> items;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.projected.sources.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.projected.sources.configmap.Items> items) {
        this.items = items;
    }
