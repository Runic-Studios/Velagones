package dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.readinessprobe;
...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.readinessprobe.httpget.HttpHeaders> httpHeaders;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.readinessprobe.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.initcontainers.readinessprobe.httpget.HttpHeaders> httpHeaders) {
