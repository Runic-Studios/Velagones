...
public class Rbd implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.volumes.rbd.SecretRef secretRef;

    public dev.agones.v1.fleetspec.template.spec.template.spec.volumes.rbd.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(dev.agones.v1.fleetspec.template.spec.template.spec.volumes.rbd.SecretRef secretRef) {
