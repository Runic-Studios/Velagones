package dev.agones.v1.fleetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec;
...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.volumes.ephemeral.volumeclaimtemplate.spec.selector.MatchExpressions> matchExpressions) {
