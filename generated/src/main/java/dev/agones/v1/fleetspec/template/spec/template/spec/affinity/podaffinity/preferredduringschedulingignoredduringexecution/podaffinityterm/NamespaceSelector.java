package dev.agones.v1.fleetspec.template.spec.template.spec.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm;
...
public class NamespaceSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> matchExpressions;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions> matchExpressions) {
