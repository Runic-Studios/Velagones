...
public class ResourceClaims implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private dev.agones.v1.fleetspec.template.spec.template.spec.resourceclaims.Source source;

    public dev.agones.v1.fleetspec.template.spec.template.spec.resourceclaims.Source getSource() {
        return source;
    }

    public void setSource(dev.agones.v1.fleetspec.template.spec.template.spec.resourceclaims.Source source) {
        this.source = source;
    }
}
