...
public class Resources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.ephemeralcontainers.resources.Claims> claims;

    public java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.ephemeralcontainers.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<dev.agones.v1.fleetspec.template.spec.template.spec.ephemeralcontainers.resources.Claims> claims) {
        this.claims = claims;
    }
