...
openApiGenerate {
    ...
    modelPackage.set("com.runicrealms.velagones.velocity.generated.model")
    apiPackage.set("com.runicrealms.velagones.velocity.generated.api")
    invokerPackage.set("com.runicrealms.velagones.velocity.generated.invoker")
