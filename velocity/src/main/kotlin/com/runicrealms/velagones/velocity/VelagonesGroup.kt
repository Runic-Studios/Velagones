 ...
 */
open class VelagonesGroup(
    protected val proxy: ProxyServer,
    plugin: VelagonesPlugin,
    protected val logger: Logger,
    val name: String,
    protected val maxCapacity: Int = Int.MAX_VALUE,
) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    if (response.success) {
                        ...
                        val gameServer =
                            VelagonesGameServer(registeredServer, channel, stub, name, maxCapacity)
